...
"--ckp_dir_name=\'runs/tod_single\' " + \
"--fusedchat_cache=\'./data_cache/tod_single_cache\' "  + \
"--tensor_dataset_cache=\'./data_cache/tod_single_tensor_cache\' "  + \
"--n_epochs=10 " + \
"--device=\'cuda\' " + \
""
